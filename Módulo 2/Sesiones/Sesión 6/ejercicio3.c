...
int main(int argc, char *argv[]){
    ...
    cerrojo1.l_type=F_WRLCK; //Cerrojo de escritura el de lectura es F_RDLCK y F_UN
    ...
    //El hijo abre el recurso2 y lo bloquea
        ...
        //Abrimos recurso2 O_TRUNC trunca a longitud 0
        if ((fd2 = open("recurso_1", O_RDWR | O_CREAT | O_TRUNC, 0664)) == -1 ){
            perror("open recurso2 fallo");
        }
        //Bloqueamos recurso2
        ...
        sleep (1); //Aseguramos que se bloquea el recurso2
